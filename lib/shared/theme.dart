...
Color kBlackColor = const Color(0xff2F3542);
Color kPrimaryColor = const Color(0xff5352ED);
Color kGreenColor = const Color(0xff54CD61);
Color kLightGreenColor = const Color(0xffE5F8E7);
Color kLightBrownColor = const Color(0xffFFF5E8);
Color kBrownColor = const Color(0xffFFB965);
Color kLightRedColor = const Color(0xffF9E2E5);
Color kRedColor = const Color(0xffD73D4F);
